...
import { FlaskConical, CheckCircle, XCircle, AlertTriangle, BarChart } from "lucide-react";
  ...
  const testResults = [
    {
      ...
      rms: "0.02 g",
      result: "success",
      notes: "Stable baseline established across 24-hour period"
    },
    {
      scenario: "Faucet Use",
      rms: "0.08-0.12 g",
      result: "success",
      notes: "Correctly identified as normal, no false alert"
    },
    {
      scenario: "Toilet Flush",
      rms: "0.15-0.25 g",
      result: "success",
      notes: "Brief spike, correctly ignored by persistence logic"
    },
    {
      scenario: "Shower Use",
      rms: "0.10-0.18 g",
      result: "success",
      notes: "Extended elevated RMS, within normal threshold"
    },
    {
      scenario: "Slow Drip Leak",
      rms: "0.05-0.08 g",
      result: "detected",
      notes: "Detected after 45 seconds persistence"
    },
    {
      scenario: "Stream Leak",
      rms: "0.18-0.30 g",
      result: "detected",
      notes: "Immediate detection within 30 seconds"
    },
    {
      scenario: "Washing Machine",
      rms: "0.20-0.35 g",
      result: "warning",
      notes: "Initial false positive; resolved with baseline adjustment"
    },
    {
      scenario: "Dishwasher",
      rms: "0.12-0.22 g",
      result: "success",
      notes: "No false alert after baseline learning"
    }
  ];
        ...
        <section className="mb-20">
          <Card className="p-8 border-2 border-[#2CB1A1] bg-gradient-to-br from-white to-[#2CB1A1]/5">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Our testing methodology involved systematic evaluation across multiple scenarios to 
              validate detection accuracy, assess false positive rates, and measure system responsiveness.
            </p>
                  ...
                  {testResults.map((test, index) => {
                    const getResultIcon = (result) => {
                      switch(result) {
                        ...
                        case 'detected': return <AlertTriangle className="w-5 h-5 text-[#2CB1A1]" />;
                        case 'warning': return <XCircle className="w-5 h-5 text-orange-500" />;
                        default: return null;
                      }
                    };
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td className="border-2 border-gray-300 p-4 text-center bg-green-50 font-bold text-green-700">
                      19<br /><span className="text-xs font-normal">(True Positive)</span>
                    </td>
                    <td className="border-2 border-gray-300 p-4 text-center bg-red-50 font-bold text-red-700">
                      1<br /><span className="text-xs font-normal">(False Negative)</span>
                    </td>
                  </tr>
                  <tr>
                    <th className="border-2 border-gray-300 p-4 bg-gray-100 font-semibold">No Leak</th>
                    <td className="border-2 border-gray-300 p-4 text-center bg-orange-50 font-bold text-orange-700">
                      3<br /><span className="text-xs font-normal">(False Positive)</span>
                    </td>
                    <td className="border-2 border-gray-300 p-4 text-center bg-green-50 font-bold text-green-700">
                      22<br /><span className="text-xs font-normal">(True Negative)</span>
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <Card className="p-8 bg-[#0E3A5D] text-white">
            ...
            <div className="mt-8 p-4 bg-white/10 rounded-lg backdrop-blur-sm">
              <p className="text-gray-200 text-sm leading-relaxed">
                <strong>Key Finding:</strong> Persistence logic reduced false positives by 73% 
                compared to simple threshold detection, while maintaining 95% detection rate 
                for genuine leak events.
              </p>
            </div>
          </Card>
        </section>
